...
namespace AuctionService.Data
{
    public class DbInitializer()
    {
        public static void InitDb(WebApplication app)
        {
            ...
            SeddData(scope.ServiceProvider.GetService<AuctionDbContext>());
        }

        private static void SeddData(AuctionDbContext? context)
        {
            ...
            new Auction
            {
                ...
                Item = new Item
                {
                    ...
                    Mileage = 150150,
                    Year = 1938,
                    Image = "https://cdn.pixabay.com/photo/2017/08/02/19/47/vintage-2573090_960_720.jpg"
                }
            }
            };
